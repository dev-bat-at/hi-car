  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        automaticallyImplyLeading: isFromSettings,
      ),
      body: SafeArea(
        child: Column(
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildModeCard(
                      ...
                      onTap: () =>
                          settings.setConnectionMode('phone_bluetooth'),
                    ),
                    ...
                    _buildModeCard(
                      ...
                      activeMode: settings.connectionMode,
                      onTap: () =>
                          settings.setConnectionMode('phone_android_auto'),
                    ),
                    SizedBox(height: 16.h),
                    _buildModeCard(
                      context,
                      ...
                      activeMode: settings.connectionMode,
                      onTap: () =>
                          settings.setConnectionMode('android_screen_box'),
                    ),
                  ],
                ),
              ),
