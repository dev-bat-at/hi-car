...
*   **API Chọn xe vận hành:** `POST /api/vehicles/select` *(Request Body: `{"vehicle_id": 12}`)*
...
*   **Endpoint:** `GET /api/audio/list` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `GET /api/audio/download/{id}` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `GET /api/v1/voice/templates` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `POST /api/v1/voice/preview` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `POST /api/v1/orders` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `POST /api/v1/orders/{order_id}/recreate` *(Yêu cầu Bearer Token)*
...
*   **Endpoint:** `POST /api/logs/error` *(Yêu cầu Bearer Token)*
